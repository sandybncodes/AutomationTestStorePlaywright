...
const ERR_MESSAGE_CLASS = '[class="alert alert-error alert-danger"]';
const ERR_MESSAGE = 'Error: Incorrect login or password provided.';
...
// invalid account
const WRONG_LOGIN_NAME = 'login_user';
const WRONG_PASSWORD = '777000';
